  ...
  return (
    <section className=" flex flex-wrap md:justify-evenly  w-full">
      ...
      <div className={`${cinzel.className} lg:w-1/2 flex flex-col md:px-20 items-center`}>
        ...
        <p className={`${halant.className} text-left pt-3 px-10 md:px-0 tracking-wide line-clamp-8 leading-loose`}>
        ...
        <p className={`${halant.className} text-left pt-6 px-10 md:px-0 tracking-wide line-clamp-6 leading-loose`}>
